                        ...
                        if (mocknet_has_forked(core.blockchain.get_current_blockchain_height() - 1) ||
                            ...
                            core.service_node_list.for_each_service_node(
                                    [this, &to_purge](
                                        ...
                                        // contributors will be empty for nodes which did not
                                        // transition with HF21, and those nodes will not be in the
                                        // contract but should be purged by decommission->deregister
