...
inline constexpr network_config config{
        ...
        .GOVERNANCE_WALLET_ADDRESS =
                {
                        "XEQSRiaXQU1QrCLQWGKKfPjcu4vYKpPAbbZmxY73dvHsEdvfDpfgf1zdnwmF3Xy7HrUNgbUB3eAJvcupZaFUo2pE4MVToAJUy5",  // HF10
                },
        ...
        .BATCHING_INTERVAL_V2 = testnet::config.BATCHING_INTERVAL,
        ...
        .DEREGISTRATION_LOCK_DURATION_V2 = testnet::config.DEREGISTRATION_LOCK_DURATION_V2,
