...
inline constexpr network_config config{
        ...
        .PUBLIC_ADDRESS_BASE58_PREFIX = 0xa01eb4,
        .PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX = 0xa01eb4,
        .PUBLIC_SUBADDRESS_BASE58_PREFIX = 0xa01eb4,
        ...
        .GOVERNANCE_WALLET_ADDRESS =
                {
                        "XEQb5MmM72EVRTVUzbR9tAD6d8Mahsf6ZcRU68dbzJpkQn69HNZUuPw524xueWNadPVtzG7zh24hED6xsYFLRwYwWSZPP4WYuKP"
                },
