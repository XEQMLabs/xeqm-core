...
inline constexpr uint64_t BLOCK_REWARD_HF19 = SN_REWARD_HF19 + FOUNDATION_REWARD_HF19;  // 20.65 XEQ per block
...
static_assert(SN_REWARD_HF19 + FOUNDATION_REWARD_HF19 == BLOCK_REWARD_HF19);
