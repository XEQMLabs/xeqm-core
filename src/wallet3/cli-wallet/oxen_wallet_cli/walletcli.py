...
@click.option('--oxend-url', default="ipc:///home/sean/.equilibria/testnet/equilibria.sock", type=str, help='Use the given daemon')
@click.option('--datadir', help='A directory which the wallet will save data')
@click.option('--rounding', help='how many decimal places will be displayed for equilibria', type=int, default=2)
